<template>
	...
	>
		<a
			...
			@click="$modal.hide('superUserContactForm')"
		>
				...
				<div class="row">
					<div class="col-12 mb-3 wrapper--validation">
						...
						<select
							...
							placeholder="Rapor"
						>
							<option value="Yanlış fiyat girişi" selected>
								Yanlış fiyat girişi
							</option>
							<option value="Marka değişikliği" selected>
								Marka değişikliği
							</option>
							<option value="Lisans değişikliği">
								Lisans değişikliği
							</option>
							<option
								value="Artık bu istasyonun sahibi/yöneticisi değilim."
							>
								Artık bu istasyonun sahibi/yöneticisi değilim.
							</option>
...
<script>
	...
	methods: {
		...
		async submit() {
			...
			payload.username = this.superUser.username;
