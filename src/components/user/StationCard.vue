			...
			>
				...
				<div class="card--station__header p-relative d-flex flex-row">
					...
					<div class="card--station__info">
						...
						<!-- mesafe -->
						<p
							class="card--station__distance fg-blue-grey-lighten-1 font-italic"
						>
							{{ Math.floor(station.distance) + " metre uzakta" }}
						</p>
					</div>
					<!-- son güncelleme -->
					<div
...
<script>
	...
	computed: {
		...mapState("station", ["stations", "location"]),

		...mapGetters({
			sortedStations: "station/sortedStations",
		}),
	},
};
</script>
